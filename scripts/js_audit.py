...
ARGS, TARGET = target_arguments("Lint JavaScript files in a static website")
JS_FILES = discover(TARGET, "*.js")
COMMAND_ARGS = ["npx", "--no-install", "eslint", *[str(path) for path in JS_FILES]]
